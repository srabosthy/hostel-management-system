...
<div class = "choice1">
<h2>Standard class available bed and rooms</h2></br>
</div>

<div class = "room1">
	<form action="guest_r_alloc_s.php" method="post">
	Bed ID:</br>
    <select name="bid">
	<?php
	include("../connection.php");
	$sql="select bed_id from admin_c_room where room_type = 'standard' and status = '0'";
...
if(isset($_POST['submit']))
{
	...
	$query="insert into request values('$email','$bid','6999')";
